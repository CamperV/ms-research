...
\textit{Show graphs of shadow removal methods here. Probably a small grid of graphs.}
...
\textit{LR Example sensitivity (one consistent, one inconsistent, one null.}
...
\textit{Should we put a cylinder here to contrast against the coneR1/R2?}
...
\textit{Draw a cube describing linear attenuation}
