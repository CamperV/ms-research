...
\begin{figure}
  ...
  \begin{subfigure}{.49\linewidth}
    ...
    \caption{}
  \end{subfigure}
  \caption{\hl{Default parameters (Default parameters set in reference implementations (Sanin et al. [\ref{Sanin}]) yield inconsistent shadow removal accuracy.} (a) Detection: 96.6637, Discrimination: 99.6233. (b) Detection: 0, Discrimination: 98.3343}
...
\begin{figure}
  ...
  \end{subfigure}
  \caption{\textit{vThreshLower} shifted from '121' to '15.' \hl{No parameter value provides consistent accuracy across datasets.} (a) Detection: 96.7076, Discrimination: 52.5296. (b) Detection: 85.0248, Discrimination: 86.5944}
  \label{fig:vthresh15}
\end{figure}
