...
python param_quantitative.py ./samples/aton_campus/ P,coneR1 0.5,0.001 optimal >> overnight_results
echo "aton_hallway [4/8] [========>       ]"
python param_quantitative.py ./samples/aton_hallway/ P,coneR1 0.5,0.001 optimal >> overnight_results
...
echo "aton_lab [7/8] [==============> ]"
python param_quantitative.py ./samples/aton_lab/ P,coneR1 0.5,0.001 optimal >> overnight_results
echo "aton_room [8/8] [================]"
